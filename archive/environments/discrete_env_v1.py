...
class PortfolioManagementEnv(gym.Env):
    ...
    # TODO differentiate between history_feature_cols and point_feature_cols
    def __init__(
        self, 
        df, 
        return_cols, 
    ...
    def get_observation(self):
        ...
        """
        return self.FEATURES[self.current_index-self.WINDOW_SIZE : self.current_index].flatten()
    ...
    def compute_return(self, previous_value):
        """
        Returns the daily return of the entire portfolio.
        """
        return (self.current_value - previous_value) / previous_value
    ...
    def step(self, action):
        ...
        ret = self.compute_return(previous_value)
    ...
    def render(self, ax, title=''): # TODO: Pass in a figure and keep updating that figure.
        """
